...
def send_password_reset_email(to_email: str, token: str) -> bool:
    ...
    message["Subject"] = "TrustMail password reset"
    message["From"] = SMTP_FROM_EMAIL
    message["To"] = to_email
    message.set_content(
        "A password reset was requested for your TrustMail account.\n\n"
        ...
        <html>
          <body style="font-family:Segoe UI,Arial,sans-serif;background:#0b1320;color:#e8eef8;padding:24px;">
            <div style="max-width:560px;margin:0 auto;background:#101827;border:1px solid #223049;border-radius:16px;padding:24px;">
              <p style="margin:0 0 8px 0;color:#60a5fa;font-size:12px;font-weight:700;letter-spacing:2px;">TRUSTMAIL AI</p>
